...
"ru": {
 ...
 "pk_cta": "Узнать цену",
 "packs": [
  {"time":"Рассвет · 1–1,5 ч","name":"Рассветная сессия","tag":"Сотни шаров над вами",
  ...
  {"time":"Закат · 1–1,5 ч","name":"Закатная сессия","tag":"Золотой час над долинами",
...
"es": {
 ...
 "pk_cta": "Pedir precio",
 "packs": [
  {"time":"Amanecer · 1–1,5 h","name":"Sesión al amanecer","tag":"Cientos de globos sobre ti",
  ...
  {"time":"Atardecer · 1–1,5 h","name":"Sesión al atardecer","tag":"Hora dorada sobre los valles",
...
"fr": {
 ...
 "packs": [
  {"time":"Aube · 1–1,5 h","name":"Séance au lever du soleil","tag":"Des centaines de montgolfières au-dessus de vous",
  ...
  {"time":"Crépuscule · 1–1,5 h","name":"Séance au coucher du soleil","tag":"L'heure dorée sur les vallées",
...
"ko": {
 ...
 "pk_cta": "가격 문의",
 "packs": [
  {"time":"일출 · 1–1.5시간","name":"선라이즈 스냅","tag":"머리 위로 수백 개의 열기구",
   "feats":["호텔 픽업 (전용 차량)","새벽 열기구와 함께 촬영","일출 명소 3곳","시그니처 소품 3종 포함","디지털 원본 전체 + 보정본 20장","의상 교체 무제한"]},
  {"time":"일몰 · 1–1.5시간","name":"선셋 스냅","tag":"계곡 위 골든아워",
...
"zh": {
 ...
 "pk_cta": "咨询价格",
 "packs": [
  {"time":"日出 · 1–1.5小时","name":"日出旅拍","tag":"数百热气球在你头顶升起",
   "feats":["专车酒店接送","黎明与热气球同框拍摄","3个最佳日出机位","含3种招牌道具","全部原片 + 20张精修","不限换装次数"]},
  {"time":"日落 · 1–1.5小时","name":"日落旅拍","tag":"山谷之上的黄金时刻",
